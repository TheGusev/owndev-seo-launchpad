      ...
      <main className="pt-24 pb-16">
        <div className="container px-4 md:px-6 max-w-3xl mx-auto">
          ...
          <article className="max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">2. Предмет Соглашения</h2>
              <p className="text-muted-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">3. Услуги Исполнителя</h2>
              <p className="text-muted-foreground mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">4. Права и обязанности сторон</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">5. Порядок оказания услуг</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">6. Стоимость и порядок оплаты</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">7. Ответственность сторон</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">8. Интеллектуальная собственность</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">9. Конфиденциальность</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">10. Разрешение споров</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">11. Изменение условий Соглашения</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">12. Заключительные положения</h2>
            ...
            <section className="mb-8">
              <h2 className="text-lg md:text-xl font-semibold mb-4 text-foreground">13. Реквизиты Исполнителя</h2>

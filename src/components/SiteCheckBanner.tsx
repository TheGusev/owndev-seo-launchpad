...
const SiteCheckBanner = () => {
  const savedUrl = typeof window !== "undefined" ? localStorage.getItem("owndev_last_url") : null;
  const href = savedUrl ? `/tools/site-check?url=${encodeURIComponent(savedUrl)}` : "/tools/site-check";

...
export const SERVICE_PRESETS: Record<string, string[]> = {
  service_geo: [
    ...
    'Изготовление памятников', 'Сборка мебели', 'Откачка септиков',
    'Установка кондиционеров', 'Эвакуация', 'Услуги муж на час',
  ],
  // PR-10/11: подкатегории локальных услуг с расширенным каталогом
  service_pest_control: [
    // Базовые услуги по СЭС
    'Дезинфекция', 'Дезинсекция', 'Дератизация', 'Фумигация',
    'Уничтожение тараканов', 'Уничтожение клопов', 'Уничтожение муравьёв',
    'Уничтожение комаров', 'Уничтожение клещей',
    'Санитарная обработка', 'Уничтожение плесени', 'Озонирование помещений',
    // PR-11: уборка после ЧП — экономически и SEO логически близко к СЭС
    'Уборка после пожара', 'Уборка после потопа',
    'Уборка после трупов', 'Уборка криминальных сцен',
    'Дезинфекция после смерти', 'Биологическая очистка',
    'Удаление трупного запаха', 'Дезодорация помещений',
  ],
  service_repair_home: [

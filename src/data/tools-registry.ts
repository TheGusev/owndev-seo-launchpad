...
export interface ToolDef {
  ...
  gradient: string;
  useCases: string[];
  /** Whether to generate GEO pages for this tool */
  geoEnabled: boolean;
}
...
export const tools: ToolDef[] = [
  // Category 1: Analysis
  {
    ...
    shortDesc: "Полный технический анализ сайта: скорость, мета-теги, структура",
    category: "analysis",
    icon: Search,
  ...
  {
    id: "indexation-checker",
    slug: "indexation-checker",
  ...
  // Category 2: Generation
  {
    ...
    slug: "pseo-generator",
    name: "pSEO Generator",
    shortDesc: "Массовая генерация структуры GEO-страниц для городов и ниш",
    category: "generation",
    icon: Sparkles,
  ...
  },
  {
    ...
    shortDesc: "JSON-LD разметка для LocalBusiness, FAQ, Organization",
    category: "generation",
    icon: Code2,
  ...
  },
  {
    ...
    slug: "roi-calculator",
    name: "ROI Calculator",
    shortDesc: "Прогноз трафика, лидов и окупаемости pSEO-проекта",
    category: "generation",
    icon: Calculator,
  ...
  // Category 3: Content
  {
    ...
    shortDesc: "Сбор и кластеризация ключевых запросов",
    category: "content",
    icon: FileText,
  ...
  },
  {
    ...
    shortDesc: "Мониторинг конкурентов и технических изменений",
    category: "monitoring",
    icon: Bell,
  ...
  // Category 5: Webmaster
  {
    id: "sitemap-generator",
    slug: "sitemap-generator",
    name: "Генератор sitemap.xml",
    shortDesc: "Автосоздание карты сайта с приоритетами",
    category: "webmaster",
    icon: FileCode,
  ...
  },
  {
    ...
    shortDesc: "Визуализация структуры внутренних ссылок",
    category: "webmaster",
    icon: Link2,
  ...
  // Category 6: Integrations
  {
    ...
    shortDesc: "Планирование охвата городов России для pSEO-проекта",
  ...
  },
  {
    ...
    shortDesc: "Выгрузка данных проекта в CSV и Excel",
    category: "integrations",
    icon: Download,
  ...
  },
  {
    ...
    slug: "telegram-bot",
    name: "Telegram-бот",
    shortDesc: "Настройка уведомлений об ошибках и позициях",
    category: "integrations",
    icon: MessageSquare,
